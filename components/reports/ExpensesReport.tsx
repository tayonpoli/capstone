        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.reportInfo}>
                    ...
                    <View style={styles.infoBox}>
                        <Text style={styles.infoLabel}>Total Hutang</Text>
                        <Text style={styles.cardValue}>{formatIDR(summaryData.account || 0)}</Text>
                    </View>
                    <View style={styles.infoBox}>
                        <Text style={styles.infoLabel}>Total Transaksi</Text>
                        <Text style={styles.cardValue}>{summaryData.totalOrders || 0} transaksi</Text>
                    </View>
                </View>
                ...
                <View style={styles.notesSection}>
                    ...
                    <Text style={styles.notesText}>
                        • Laporan ini memuat semua transaksi pengeluaran dalam periode tanggal yang ditentukan.
                    </Text>
                    <Text style={styles.notesText}>
